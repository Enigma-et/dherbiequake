        ...
        <div className="container mx-auto px-4 relative z-10">
          ...
          >
            ...
            <h1 className="text-5xl md:text-6xl font-bold text-foreground mb-8 font-montserrat leading-tight">
              Creative
              <span className="block text-primary">Directing</span>
            </h1>
            <div className="w-24 h-1 bg-primary mx-auto mb-8"></div>
            <p className="text-xl text-muted-foreground leading-relaxed mb-12">
              I see creativity as translation turning vision into something
              people can feel. Every brand has a pulse, a rhythm that deserves
              to be heard and seen. My role as a Creative Director is to find
              that rhythm and express it through visuals, stories, and
              experiences that truly move people.
            </p>
            <Button
              asChild
              size="lg"
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <CardContent className="p-6">
                  <div className="flex items-center mb-4">
                    ...
                    <h3 className="text-xl font-bold text-foreground font-montserrat">
                      Creative Direction & Campaign Oversight
                    </h3>
                  </div>
                  <p className="text-muted-foreground leading-relaxed">
                    Leading the creative vision and ensuring every element
                    aligns with the brand strategy and objectives.
                  </p>
                </CardContent>
              </Card>
              ...
              <Card className="bg-white/50 backdrop-blur-sm border-0 shadow-lg hover:shadow-2xl transition-all duration-300 hover:-translate-y-1">
                <CardContent className="p-6">
                  ...
                  <p className="text-muted-foreground leading-relaxed">
                    Ensuring consistent brand expression across all channels,
              ...
              <Card className="bg-white/50 backdrop-blur-sm border-0 shadow-lg hover:shadow-2xl transition-all duration-300 hover:-translate-y-1">
                <CardContent className="p-6">
                  ...
                  <p className="text-muted-foreground leading-relaxed">
                    Creating compelling visual narratives and innovative
                    concepts that capture attention and drive engagement.
                  </p>
                </CardContent>
              </Card>
              ...
              <Card className="bg-white/50 backdrop-blur-sm border-0 shadow-lg hover:shadow-2xl transition-all duration-300 hover:-translate-y-1">
                <CardContent className="p-6">
                  <div className="flex items-center mb-4">
                    ...
                    <h3 className="text-xl font-bold text-foreground font-montserrat">
                      Consistent Expression Across Design, Messaging, and
                      Experience
                    </h3>
                  </div>
                  <p className="text-muted-foreground leading-relaxed">
                    Maintaining brand consistency across all creative elements
                    while ensuring each touchpoint delivers impact.
                  </p>
                </CardContent>
              </Card>
            </div>
                ...
                <CardContent className="p-8">
                  <div className="flex items-start space-x-4">
                    ...
                    <div>
                      ...
                      <p className="text-muted-foreground leading-relaxed">
                        I begin by understanding your brand's essence: its
                        story, purpose, and energy. This deep dive ensures every
                        creative decision is rooted in truth.
                      </p>
                    </div>
                  </div>
                </CardContent>
                ...
                <CardContent className="p-8">
                  <div className="flex items-start space-x-4">
                    ...
                    <div>
                      ...
                      <p className="text-muted-foreground leading-relaxed">
                        From there, I lead creative execution that embodies that
                        truth. I direct with intention, ensuring every detail
                        mirrors your brand's core.
                      </p>
                    </div>
                  </div>
                </CardContent>
                ...
                <CardContent className="p-8">
                  <div className="flex items-start space-x-4">
                    ...
                    <div>
                      ...
                      <p className="text-muted-foreground leading-relaxed">
                        For every experience, I ensure every detail mirrors your
                        brand's core. The result is creative work that doesn't
                        just get attention, but creates lasting impact.
                      </p>
                    </div>
                  </div>
                </CardContent>
          ...
          <div className="max-w-4xl mx-auto text-center">
            <div className="bg-white/10 backdrop-blur-sm rounded-2xl p-8 mb-12 border border-white/20">
              <blockquote className="text-2xl md:text-3xl text-foreground italic leading-relaxed font-lato">
                "Let's create not just for attention but for expression. I see
                creativity as translation turning vision into something people
                can feel. Every brand has a pulse, a rhythm that deserves to be
                heard and seen."
              </blockquote>
            </div>
